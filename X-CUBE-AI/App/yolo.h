...
/******************************************************************************/
#define AI_YOLO_MODEL_NAME          "yolo"
#define AI_YOLO_ORIGIN_MODEL_NAME   "yoloface_int8"

/******************************************************************************/
#define AI_YOLO_ACTIVATIONS_ALIGNMENT   (4)
#define AI_YOLO_INPUTS_IN_ACTIVATIONS   (4)
#define AI_YOLO_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_YOLO_IN_NUM        (1)

AI_DEPRECATED
#define AI_YOLO_IN \
  ai_yolo_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_YOLO_IN_SIZE { \
  AI_YOLO_IN_1_SIZE, \
}
#define AI_YOLO_IN_SIZE_BYTES { \
  AI_YOLO_IN_1_SIZE_BYTES, \
}
#define AI_YOLO_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_YOLO_IN_1_HEIGHT      (56)
#define AI_YOLO_IN_1_WIDTH       (56)
#define AI_YOLO_IN_1_CHANNEL     (3)
#define AI_YOLO_IN_1_SIZE        (9408)
#define AI_YOLO_IN_1_SIZE_BYTES  (9409)

/******************************************************************************/
#define AI_YOLO_OUT_NUM       (1)

AI_DEPRECATED
#define AI_YOLO_OUT \
  ai_yolo_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_YOLO_OUT_SIZE { \
  AI_YOLO_OUT_1_SIZE, \
}
#define AI_YOLO_OUT_SIZE_BYTES { \
  AI_YOLO_OUT_1_SIZE_BYTES, \
}
#define AI_YOLO_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_YOLO_OUT_1_HEIGHT      (7)
#define AI_YOLO_OUT_1_WIDTH       (7)
#define AI_YOLO_OUT_1_CHANNEL     (18)
#define AI_YOLO_OUT_1_SIZE        (882)
#define AI_YOLO_OUT_1_SIZE_BYTES  (882)

/******************************************************************************/
#define AI_YOLO_N_NODES (57)
 ...
 */
AI_API_ENTRY
ai_error ai_yolo_get_error(ai_handle network);
 ...
 */
AI_API_ENTRY
ai_handle ai_yolo_destroy(ai_handle network);
 ...
 * @ref ai_yolo_create. Both the activations memory buffer 
 ...
 * using @ref ai_yolo_get_error
 */
AI_API_ENTRY
ai_bool ai_yolo_init(
 ...
 */
AI_API_ENTRY
ai_error ai_yolo_create_and_init(
 ...
 * header generated by the code generation tool. See AI_YOLO_*
 * defines into file @ref yolo.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
