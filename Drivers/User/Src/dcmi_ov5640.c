...
// 初始化 PWDN 引脚  
		OV5640_PWDN_OFF;	// 低电平，退出掉电模式，摄像头开始工作
...
void OV5640_Reset(void)
{
	...
	OV5640_PWDN_OFF;  // PWDN 引脚输出低电平，退出掉电模式，摄像头正常工作
...
void OV5640_hw_init(void)
{
    ...
    /* 初始化FLASH引脚 */
		GPIO_InitTypeDef GPIO_InitStruct = {0};
		ATK_MC5640_FLASH_GPIO_CLK_ENABLE();
    GPIO_InitStruct.Pin    = ATK_MC5640_FLASH_GPIO_PIN;
    GPIO_InitStruct.Mode   = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull   = GPIO_PULLUP;
    GPIO_InitStruct.Speed  = GPIO_SPEED_FREQ_HIGH;
    HAL_GPIO_Init(ATK_MC5640_FLASH_GPIO_PORT, &GPIO_InitStruct);
#endif
#if (ATK_MC5640_LED_CTL_BY_OV5640 == 0)
			ATK_MC5640_FLASH(0);
#endif
...
uint8_t atk_mc5640_set_light_mode(atk_mc5640_light_mode_t mode)
{
    switch (mode)
    {
        ...
        {
            SCCB_WriteReg_16Bit(0x3406, 0x00);
            SCCB_WriteReg_16Bit(0x5192, 0x04);
            SCCB_WriteReg_16Bit(0x5191, 0xF8);
            SCCB_WriteReg_16Bit(0x5193, 0x70);
            SCCB_WriteReg_16Bit(0x5194, 0xF0);
            SCCB_WriteReg_16Bit(0x5195, 0xF0);
            SCCB_WriteReg_16Bit(0x518D, 0x3D);
            SCCB_WriteReg_16Bit(0x518F, 0x54);
            SCCB_WriteReg_16Bit(0x518E, 0x3D);
            SCCB_WriteReg_16Bit(0x5190, 0x54);
            SCCB_WriteReg_16Bit(0x518B, 0xA8);
            SCCB_WriteReg_16Bit(0x518C, 0xA8);
            SCCB_WriteReg_16Bit(0x5187, 0x18);
            SCCB_WriteReg_16Bit(0x5188, 0x18);
            SCCB_WriteReg_16Bit(0x5189, 0x6E);
            SCCB_WriteReg_16Bit(0x518A, 0x68);
            SCCB_WriteReg_16Bit(0x5186, 0x1C);
            SCCB_WriteReg_16Bit(0x5181, 0x50);
            SCCB_WriteReg_16Bit(0x5184, 0x25);
            SCCB_WriteReg_16Bit(0x5182, 0x11);
            SCCB_WriteReg_16Bit(0x5183, 0x14);
            SCCB_WriteReg_16Bit(0x5184, 0x25);
            SCCB_WriteReg_16Bit(0x5185, 0x24);
            break;
        }
        case ATK_MC5640_LIGHT_MODE_SIMPLE_AWB:
        {
            SCCB_WriteReg_16Bit(0x3406, 0x00);
            SCCB_WriteReg_16Bit(0x5183, 0x94);
            SCCB_WriteReg_16Bit(0x5191, 0xFF);
            SCCB_WriteReg_16Bit(0x5192, 0x00);
            break;
        }
        case ATK_MC5640_LIGHT_MODE_MANUAL_DAY:
        {
            SCCB_WriteReg_16Bit(0x3406, 0x01);
            SCCB_WriteReg_16Bit(0x3400, 0x06);
            SCCB_WriteReg_16Bit(0x3401, 0x1C);
            SCCB_WriteReg_16Bit(0x3402, 0x04);
            SCCB_WriteReg_16Bit(0x3403, 0x00);
            SCCB_WriteReg_16Bit(0x3404, 0x04);
            SCCB_WriteReg_16Bit(0x3405, 0xF3);
            break;
        }
        case ATK_MC5640_LIGHT_MODE_MANUAL_A:
        {
            SCCB_WriteReg_16Bit(0x3406, 0x01);
            SCCB_WriteReg_16Bit(0x3400, 0x04);
            SCCB_WriteReg_16Bit(0x3401, 0x10);
            SCCB_WriteReg_16Bit(0x3402, 0x04);
            SCCB_WriteReg_16Bit(0x3403, 0x00);
            SCCB_WriteReg_16Bit(0x3404, 0x08);
            SCCB_WriteReg_16Bit(0x3405, 0xB6);
            break;
        }
        case ATK_MC5640_LIGHT_MODE_MANUAL_CWF:
        {
            SCCB_WriteReg_16Bit(0x3406, 0x01);
            SCCB_WriteReg_16Bit(0x3400, 0x05);
            SCCB_WriteReg_16Bit(0x3401, 0x48);
            SCCB_WriteReg_16Bit(0x3402, 0x04);
            SCCB_WriteReg_16Bit(0x3403, 0x00);
            SCCB_WriteReg_16Bit(0x3404, 0x07);
            SCCB_WriteReg_16Bit(0x3405, 0xCF);
            break;
        }
        case ATK_MC5640_LIGHT_MODE_MANUAL_CLOUDY:
        {
            ...
            SCCB_WriteReg_16Bit(0x3403, 0x00);
            SCCB_WriteReg_16Bit(0x3404, 0x04);
            SCCB_WriteReg_16Bit(0x3405, 0xD3);
            break;
        }
        default:
        {
...
void atk_mc5640_led_on(void)
{
    SCCB_WriteReg_16Bit(0x3016, 0x02);
    SCCB_WriteReg_16Bit(0x301C, 0x02);
    SCCB_WriteReg_16Bit(0x3019, 0x02);
}
...
void atk_mc5640_led_off(void)
{
    SCCB_WriteReg_16Bit(0x3016, 0x02);
    SCCB_WriteReg_16Bit(0x301C, 0x02);
    SCCB_WriteReg_16Bit(0x3019, 0x00);
}
#endif
